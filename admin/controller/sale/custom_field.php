	...
	protected function getList() {
		...
		foreach ($results as $result) {
			...
			$data['custom_fields'][] = array(
				...
				'edit_custom'            => $this->url->link('sale/xcustom_field/edit', 'token=' . $this->session->data['token'] . '&custom_field_id=' . $result['custom_field_id'] . $url, 'SSL'),
		...
		$data['add_custom'] = $this->url->link('sale/xcustom_field/add', 'token=' . $this->session->data['token'] . $url, 'SSL');
