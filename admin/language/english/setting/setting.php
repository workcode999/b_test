<?php
//Tabs
$_['tab_ips']                            = 'Increase Page Speed 5.2';
...
$_['heading_speed_analyzer']             = 'PERFORMANCE ANALYZER';
$_['heading_block_level_caching']        = 'BLOCK LEVEL CACHING';

//Entry
$_['entry_google_speed_api']             = 'Google API Key<br /><span class="help">Google Page Speed API Key.</span>';
$_['entry_google_server_ip']             = 'Server IP<br /><span class="help">In order to communicate with the Google API you must authorize the server IP.  Your server IP is:</span>';


$_['entry_minify_javascript']            = 'Minify Javascript';
$_['entry_javascript_jquery']            = 'jQuery Google';
$_['entry_javascript_jquery_version']    = 'jQuery Version';
$_['entry_javascript_jqueryui']          = 'jQuery UI Google';
$_['entry_javascript_jqueryui_version']  = 'jQuery UI Version';
$_['entry_javascript_defer']             = 'Defer Javascript';

$_['help_minify_javascript']             = 'The combination, minification, compression, and caching for JavaScript files.';
$_['help_javascript_jquery']             = 'Serve JQuery library seperately over Google C.D.N. (requires minifier)';
$_['help_javascript_jquery_version']     = 'If using Google C.D.N, the optimizer will attempt to automatically detect the and use the version on page, ultimately you may specify an override here.';
$_['help_javascript_jqueryui']           = 'Serve JQuery UI library seperately over Google C.D.N. (requires minifier)';
$_['help_javascript_jqueryui_version']   = 'If using Google C.D.N, the optimizer will attempt to automatically detect the and use the version on page, ultimately you may specify an override here.';
$_['help_javascript_defer']              = 'Defer Parsing of all JavaScript until document has completed loading.';

$_['entry_minify_css']                   = 'Minify CSS';
$_['entry_css_defer']                    = 'Defer CSS';
$_['entry_minify_cache']                 = 'Minify Cache Enabled';
$_['entry_minify_encode_images']         = 'Encode Small Images'; 
$_['entry_minify_image_size']            = 'Maximum Image Size'; 
$_['entry_minify_image_occurs']          = 'Image Occurance'; 
$_['entry_minify_encode_url']            = 'Encode URL(s)'; 
$_['entry_minify_storage']               = 'Storage Location'; 
$_['entry_minify_advanced']              = 'Advanced Settings';
$_['entry_minify_logging']               = 'Error Logging';
$_['entry_minify_debug_mode']            = 'Debug Mode';
$_['entry_minify_max_age']               = 'Maximum Age';
$_['entry_minify_file_path']             = 'File Path';
$_['entry_minify_file_locking']          = 'File Locking';
$_['entry_ipsjs_excludes']               = 'Javascript Exclude';
$_['entry_ipscss_excludes']              = 'CSS Exclude';

$_['help_minify_css']                    = 'The combination, minification, compression, and caching for CSS.';
$_['help_css_defer']                     = 'Load CSS after page render & JavaScript initilization (non-blocking CSS load).';
$_['help_minify_cache']                  = 'The combination, minification, compression, and caching for CSS & Javascript (global on/off).';
$_['help_minify_encode_images']          = 'Encode Small images to be inline in CSS files to save additional server requests.'; 
$_['help_minify_image_size']             = 'The largest size of image which should be encoded in CSS files.'; 
$_['help_minify_image_occurs']           = 'The largest number of times an image can occur and be encoded in CSS.'; 
$_['help_minify_encode_url']             = 'Encodes the combined urls used for CSS & JavaScript so that they do not contain dynamic parameters (must be off to use debugging).'; 
$_['help_minify_storage']                = 'Controls the storage location of the combined files (memory being faster).'; 
$_['help_minify_advanced']               = 'Unless you are attempting to resolve a problem, leave these settings at default values.';
$_['help_minify_logging']                = 'Error logging for Minification libraries.';
$_['help_minify_debug_mode']             = 'Loads URLS in debugging mode (produces a detailed, non-functional output for visual debugging).';
$_['help_minify_max_age']                = 'The cache lifetime specified to client browsers when serving combined CSS/JS files.';
$_['help_minify_file_path']              = 'Full file path to the \'min\' folder within OpenCart (blank = autodetect)';
$_['help_minify_file_locking']           = 'The mode in which files should be accessed';
$_['help_ipsjs_excludes']                = 'Javascript to exclude from I.P.S combination. Seperated by comma.';
$_['help_ipscss_excludes']               = 'CSS to exclude from I.P.S combination. Seperated by comma.';

$_['entry_firebug_analyzer']             = 'Performance Analyzer';
$_['entry_firebug_queries']              = 'Slow Query Output';

$_['help_firebug_analyzer']              = 'Enables page generation stats and database query time statistics to FireFox. (firebug and firephp browser plug-ins required)';
$_['help_firebug_queries']               = 'Displays slow queries into firebug console to assist in determining what database queries (3rd party modules) are slowing down your site. (DO NO LEAVE ENABLED, ONLY USE FOR DEBUGGING)';

$_['entry_jpeg_compression']             = 'JPEG Compression';
$_['entry_logo_dimensions']              = 'Logo Dimensions';
$_['entry_image_dimensions']             = 'Image Dimension Specifiers';

$_['help_jpeg_compression']             = 'Compression quality settings for JPEG images (value between 0-100).';
$_['help_logo_dimensions']              = 'Adds dimension specifiers to logo. (0\'s = disabled)';
$_['help_image_dimensions']             = 'Adds dimensions to various areas of OpenCart modules.';
...
$_['entry_minify_cache']                 = 'Minify Cache Enabled';
$_['entry_minify_html']                  = 'Minify HTML Enabled';
$_['entry_advanced_imaging']             = 'Advanced Image Processing';
$_['entry_memory_cache']                 = 'Memory Data Caching';
$_['entry_ipsjs_excludes']               = 'Javascript Exclude';
$_['entry_ipscss_excludes']              = 'CSS Exclude';

$_['help_minify_cache']                  = 'The combination, minification, compression, and caching for CSS & Javascript.';
$_['help_minify_html']                   = 'If HTML content should be minified prior to compression.';
$_['help_advanced_imaging']              = 'Make use of Yahoo\'s Smush.It imaging service to compress images. (not recommended for OC 1.5.4+)';
$_['help_memory_cache']                  = 'If enabled on your server, you may choose a memory caching mechanism.';
$_['help_ipsjs_excludes']                = 'Javascript to exclude from I.P.S combination. Seperated by comma.';
$_['help_ipscss_excludes']               = 'CSS to exclude from I.P.S combination. Seperated by comma.';

$_['entry_cdn_status']                   = 'CDN Status';
$_['entry_cdn_http']                     = 'CDN HTTP URL';
$_['entry_cdn_https']                    = 'CDN HTTPS URL';
$_['entry_cdn_images']                   = 'Serve Images';
$_['entry_cdn_css']                      = 'Serve CSS';
$_['entry_cdn_js']                       = 'Serve JavaScript';

$_['help_cdn_status']                   = 'Globally enable/disable content serving via our CDN/sub-domain.';
$_['help_cdn_http']                     = 'If you are using a CDN (or a sub-domain for cookieless delivery), you may specify the HTTP base url here.';
$_['help_cdn_https']                    = 'If you are using a CDN (or a sub-domain for cookieless delivery), you may specify the HTTPS base url here.';
$_['help_cdn_images']                   = 'Serve Images via the CDN.';
$_['help_cdn_css']                      = 'Serve CSS via the CDN.';
$_['help_cdn_js']                       = 'Serve JavaScript via the CDN.';

$_['entry_cached_routes']                = 'Cached Routes';
$_['help_cached_routes']                 = 'Define a list of content (children) that can be globally cached and re-used instead of live rendered.  This list should be populated with sub-renders and not entire pages (eg. \'module/featured\', \'common/footer\').  You should never cache routes that have unique content for each page (eg. \'common/header\').';

// Texts
$_['text_enabled']                       = 'Enabled';
$_['text_google_speed_api_validate']     = 'Validate API Credentials';
