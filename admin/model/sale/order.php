...
class ModelSaleOrder extends Model {
	...
	public function getOrdersexport($data = array()) {
		 	$sql = "SELECT o.order_id, o.store_url, o.store_url, cgd.name as customer_group, CONCAT(o.firstname, ' ', o.lastname) AS customer_name,
		...
		CONCAT(o.shipping_firstname, ' ', o.shipping_lastname,'+',o.shipping_address_1,'+',o.shipping_address_2,'+',o.shipping_city,', ',o.shipping_zone,' ',o.shipping_postcode,'+',o.shipping_country) AS shipping_address, o.shipping_custom_field, o.payment_method, o.shipping_method, o.total, o.currency_code,o.currency_value,
	...
	/*public function getcolorByProdcutID($product_id){
		$query = $this->db->query("SELECT text FROM " . DB_PREFIX . "product_attribute WHERE product_id = ".(int)$product_id." AND attribute_id = '5'");
		return  $query->row;
		}*/
}
