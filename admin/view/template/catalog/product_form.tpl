          ...
          <div class="tab-content">
            <div class="tab-pane active" id="tab-general">
              ...
              <div class="tab-content">
				...
				<label class="col-sm-2 control-label" for="input-extra_field<?php echo $language['language_id']; ?>">Product Promotional Info</label>
						<div class="col-sm-10">
						  <textarea class="form-control" name="product_promotional_info[<?php echo $language['language_id']; ?>][extra_field]" placeholder="Enter Product Promotional Info" id="input-extra_field<?php echo $language['language_id']; ?>"><?php echo isset($product_promotional_info[$language['language_id']]) ? $product_promotional_info[$language['language_id']]['extra_field'] : ''; ?></textarea>
						</div>
				</div>		  
                  <div class="form-group">
                ...
                <div class="col-sm-10">
                  <div class="tab-content">
                    ...
                    <div class="tab-pane" id="tab-option<?php echo $option_row; ?>">
                      ...
                      <?php } ?>
                      <?php if ($product_option['type'] == 'select' || $product_option['type'] == 'radio' || $product_option['type'] == 'checkbox' || $product_option['type'] == 'image' || $product_option['type'] == 'size_option') { ?>
                      <div class="table-responsive">
...
$('input[name=\'option\']').autocomplete({
	...
	'select': function(item) {
       ...
       if (item['type'] == 'select' || item['type'] == 'radio' || item['type'] == 'checkbox' || item['type'] == 'image' || item['type'] == 'size_option') {
