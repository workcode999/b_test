...
<script type="text/javascript" src="view/javascript/jquery/browser.js"></script>
  ...
  <ul class="nav pull-right">
    <li class="dropdown"><a class="dropdown-toggle" data-toggle="dropdown"><span class="label label-danger pull-left"><?php echo $alerts; ?></span> <i class="fa fa-bell fa-lg"></i></a>
      <ul class="dropdown-menu dropdown-menu-right alerts-dropdown">
        ...
        <li><a href="<?php echo $review; ?>">   <?php if(isset($qa)) { ?><li><a href="<?php echo $qa; ?>"><span class="label label-danger pull-right"><?php echo $total_unanswered_questions; ?></span><?php echo $text_unanswered_questions; ?></a></li><?php } ?>
<?php if(isset($qa)) { ?><li><a href="<?php echo $qa; ?>"><span class="label label-danger pull-right"><?php echo $total_unanswered_questions; ?></span><?php echo $text_unanswered_questions; ?></a></li><?php } ?><span class="label label-danger pull-right"><?php echo $review_total; ?></span><?php echo $text_review; ?></a></li>
        <li class="divider"></li>
