<ul id="menu">
  ...
  <li id="catalog"><a class="parent"><i class="fa fa-tags fa-fw"></i> <span><?php echo $text_catalog; ?></span></a>
    <ul>
      ...
      <li><a href="<?php echo $review; ?>"><?php echo $text_review; ?><?php if(isset($qa)) { ?><li><a href="<?php echo $qa; ?>"><?php echo $text_qa; ?></a></li><?php } ?></a></li>
    ...
    <ul>
      ...
      <li><a class="parent"><?php echo $text_customer; ?></a>
        <ul>
		  ...
		  <li><a href="<?php echo $xcustom_fields; ?>"><?php echo $text_xcustom_field; ?></a></li>
  ...
  <li id="tools"><a class="parent"><i class="fa fa-wrench fa-fw"></i> <span><?php echo $text_tools; ?></span></a>
	...
	<li id="clear-all-caches"><a class="parent"><i class="fa fa-trash fa-fw"></i> <span><?php echo $text_clear_caches; ?></span></a>
		<ul>
			<li><a href="<?php echo $url_clear_allbutimage; ?>"><?php echo $text_clear_allbutimage; ?></a></li>
			...
			<li><a href="<?php echo $url_clear_image; ?>"><?php echo $text_clear_image; ?></a></li>
			...
			<li><a href="<?php echo $url_clear_seo; ?>"><?php echo $text_clear_seo; ?></a></li>
			<?php if (file_exists(DIR_SYSTEM . '../pagecache/caching.php')) { ?><li><a href="<?php echo $url_clear_page ?>"><?php echo $text_clear_page; ?></a></li> <?php } ?>
		</ul>
	</li>
