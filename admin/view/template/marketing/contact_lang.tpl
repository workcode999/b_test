      ...
      <div class="panel-body">
            ...
            <div class="tab-content">
              ...
              <div class="form-group required">
	            ...
	            <div class="col-sm-10">
	              <input type="text" name="subject[<?php echo $language['language_id']; ?>]" value="" placeholder="<?php echo $entry_subject; ?>" id="input-subject-<?php echo $language['language_id']; ?>" class="form-control" />
	            </div>
	          </div>
	          <div class="form-group required">
	            <label class="col-sm-2 control-label" for="input-message-<?php echo $language['language_id']; ?>"><?php echo $entry_message; ?></label>
	            <div class="col-sm-10">
	              <textarea name="message[<?php echo $language['language_id']; ?>]" placeholder="<?php echo $entry_message; ?>" id="input-message-<?php echo $language['language_id']; ?>" class="language_editor form-control"></textarea>
		            </div>
		          </div>
        		</div>
        		<?php $i++; } ?>
