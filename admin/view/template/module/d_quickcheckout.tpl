          ...
          <div class="row">
            <div class="col-md-6">
             ...
             <div class="form-group">
              ...
              <div class="col-sm-6">
               <div class="checkbox">
                <label>
                 <input type="hidden" value="0" name="d_quickcheckout[general][enable]" />
                 <?php if(isset($d_quickcheckout['general']['enable']) && $d_quickcheckout['general']['enable'] == 1){ ?>
                  <input type="checkbox" value="1" name="d_quickcheckout[general][enable]" id="checkout_enable" checked="checked" /> 
                 <?php }else{ ?>
                  <input type="checkbox" value="1" name="d_quickcheckout[general][enable]" id="checkout_enable"/> 
                 <?php } ?> 
               ...
               <div class="radio">
                <?php if(isset($d_quickcheckout['general']['default_option']) && $d_quickcheckout['general']['default_option'] == 'guest'){ ?>
                 <label for="general_default_option_guest">
                  <input type="radio" value="guest" name="d_quickcheckout[general][default_option]" checked="checked" id="general_default_option_guest" />
                  <?php echo $text_guest; ?>
                 </label>
                 <label for="general_default_option_register">
                  <input type="radio" value="register" name="d_quickcheckout[general][default_option]" id="general_default_option_register" />
                  <?php echo $text_register; ?>
                 </label>
                <?php }else{ ?>
                 <label for="general_default_option_guest">
                  <input type="radio" value="guest" name="d_quickcheckout[general][default_option]" id="general_default_option_guest" />
                  <?php echo $text_guest; ?>
                 </label>
                 <label for="general_default_option_register">
                  <input type="radio" value="register" name="d_quickcheckout[general][default_option]" checked="checked" id="general_default_option_register" />
                  <?php echo $text_register; ?>
                 </label>
                <?php } ?>
               </div>
              ...
              <div class="col-sm-6">
               <div class="checkbox">
                <label for="general_main_checkout">
                 <input type="hidden" value="0" name="d_quickcheckout[general][main_checkout]" />
                 <?php if(isset($d_quickcheckout['general']['main_checkout']) && $d_quickcheckout['general']['main_checkout'] == 1){ ?>
                  <input type="checkbox" value="1" name="d_quickcheckout[general][main_checkout]" checked="checked" id="general_main_checkout" />
                 <?php }else{ ?>
                  <input type="checkbox" value="1" name="d_quickcheckout[general][main_checkout]" id="general_main_checkout" />
                 <?php } ?>
                 <?php echo $text_enable; ?>
                </label>
               </div>
              ...
              <div class="col-sm-6">
               <div class="checkbox">
                <label for="general_clear_session">
                 <input type="hidden" value="0" name="d_quickcheckout[general][clear_session]" />
                 <?php if(isset($d_quickcheckout['general']['clear_session']) && $d_quickcheckout['general']['clear_session'] == 1){ ?>
                  <input type="checkbox" value="1" name="d_quickcheckout[general][clear_session]" checked="checked" id="general_clear_session" />
                 <?php }else{ ?>
                  <input type="checkbox" value="1" name="d_quickcheckout[general][clear_session]" id="general_clear_session" />
                 <?php } ?>
                 <?php echo $text_enable; ?>
                </label>
               </div>
              ...
              <div class="col-sm-6">
               <div class="checkbox">
                <label for="general_login_refresh">
                 <input type="hidden" value="0" name="d_quickcheckout[general][login_refresh]" />
                 <?php if(isset($d_quickcheckout['general']['login_refresh']) && $d_quickcheckout['general']['login_refresh'] == 1){ ?>
                  <input type="checkbox" value="1" name="d_quickcheckout[general][login_refresh]" checked="checked" id="general_login_refresh" />
                 <?php }else{ ?>
                  <input type="checkbox" value="1" name="d_quickcheckout[general][login_refresh]" id="general_login_refresh" />
                 <?php } ?>
                 <?php echo $text_enable; ?>
                </label>
               </div>
             ...
             <div class="form-group">
              ...
              <div class="col-sm-6">
                <?php if(isset($d_quickcheckout['general']['default_email']) && $d_quickcheckout['general']['default_email'] != ""){ ?>
                 <input type="text" value="<?php echo $d_quickcheckout['general']['default_email']; ?>" name="d_quickcheckout[general][default_email]" id="general_default_email" class="form-control">
                <?php }else{ ?>
                 <input type="text" value="0" name="d_quickcheckout[general][default_email]" id="general_default_email" class="form-control"/>
                <?php } ?>
              </div>
             </div>
              ...
              <div class="col-sm-6">
               <div class="checkbox">
                <label for="general_debug">
                 <input type="hidden" value="0" name="d_quickcheckout[general][debug]" />
                 <?php if(isset($d_quickcheckout['general']['debug']) && $d_quickcheckout['general']['debug'] == 1){ ?>
                  <input type="checkbox" value="1" name="d_quickcheckout[general][debug]" checked="checked" id="general_debug" />
                 <?php }else{ ?>
                  <input type="checkbox" value="1" name="d_quickcheckout[general][debug]" id="general_debug" />
                 <?php } ?>
                 <?php echo $text_enable; ?>
                </label>
               </div>
              ...
              <div class="col-sm-6">
               <div class="input-group">
                ...
                <?php if(isset($d_quickcheckout['general']['min_order']['value']) && $d_quickcheckout['general']['min_order']['value'] != ""){ ?>
                 <input type="text" value="<?php echo $d_quickcheckout['general']['min_order']['value']; ?>" name="d_quickcheckout[general][min_order][value]" id="general_min_order_value" class="form-control"/>
                <?php }else{ ?>
                 <input type="text" value="0" name="d_quickcheckout[general][min_order][value]" class="form-control" id="general_min_order_value"/>
                <?php } ?>
               </div>
               ...
               <div id="tab_general_min_order_text_<?php echo $language['language_id']; ?>" class="input-group">
                ...
                <input type="text" name="d_quickcheckout[general][min_order][text][<?php echo $language['language_id']; ?>]" id="general_min_order_text_<?php echo $language['language_id']; ?>" value="<?php echo isset($d_quickcheckout['general']['min_order']['text'][$language['language_id']]) ? $d_quickcheckout['general']['min_order']['text'][$language['language_id']] : $text_value_min_order; ?>" class="form-control" >
               </div>
               <?php } ?>
              </div>
             </div>
              ...
              <div class="col-sm-6">
               <div class="input-group">
                ...
                <?php if(isset($d_quickcheckout['general']['min_quantity']['value']) && $d_quickcheckout['general']['min_quantity']['value'] != ""){ ?>
                 <input type="text" value="<?php echo $d_quickcheckout['general']['min_quantity']['value']; ?>" name="d_quickcheckout[general][min_quantity][value]" id="general_min_quantity_value" class="form-control"/>
                <?php }else{ ?>
                 <input type="text" value="0" name="d_quickcheckout[general][min_quantity][value]" class="form-control" id="general_min_quantity_value"/>
                <?php } ?>
               </div>
             ...
             <div class="form-group">
              ...
              <div class="col-sm-6">
                <?php if(isset($d_quickcheckout['general']['trigger']) && $d_quickcheckout['general']['trigger'] != ""){ ?>
                 <input type="text" value="<?php echo $d_quickcheckout['general']['trigger']; ?>" name="d_quickcheckout[general][trigger]" id="general_trigger" class="form-control"/>
                <?php }else{ ?>
                 <input type="text" value="0" name="d_quickcheckout[general][trigger]" id="general_trigger" class="form-control"/>
                <?php } ?>
              </div>
             </div>
            </div>
            ...
            <p class="hidden"><?php echo $help_position_module; ?></p>
              <table id="module" class="hidden table table-striped table-bordered table-hover">
               ...
               <tr>
                <td class="text-left">
                 <select name="d_quickcheckout_module[<?php echo $module_row; ?>][layout_id]" class="form-control">
                ...
                <td class="text-left">
                 <select name="d_quickcheckout_module[<?php echo $module_row; ?>][position]" class="form-control">
                ...
                <td class="text-left">
                 <select name="d_quickcheckout_module[<?php echo $module_row; ?>][status]" class="form-control">
                ...
                <td class="text-left">
                 <input type="text" name="d_quickcheckout_module[<?php echo $module_row; ?>][sort_order]" value="<?php echo $module['sort_order']; ?>" size="3" class="form-control" />
                </td>
                <td class="text-left">
         ...
         <div id="login" class="tab-pane">
           ...
           <?php foreach($d_quickcheckout['general']['social_login']['providers'] as $provider_name => $provider){ ?>
            ...
            <div class="clearfix sort-item atab-item list-group-item">
             ...
             <div class="col-sm-7"><span>
              <input type="hidden" class="sort-value" value="<?php echo $provider['sort_order']; ?>" name="d_quickcheckout[general][social_login][providers][<?php echo $provider_name; ?>][sort_order]">
              <input type="hidden" value="0" name="d_quickcheckout[general][social_login][providers][<?php echo $provider_name; ?>][enabled]">
              <input type="checkbox" value="1" id="general_social_login_providers_<?php echo $provider['id']; ?>" <?php echo ($provider['enabled']) ? 'checked="checked"': ''; ?> name="d_quickcheckout[general][social_login][providers][<?php echo $provider_name; ?>][enabled]"> <label for="general_social_login_providers_<?php echo $provider['id']; ?>"><?php echo $text_enable; ?><label></span> 
           ...
           <div class="col-md-7">
            ...
            <div class="form-group">
             ...
             <div class="col-sm-6">
              <select name="d_quickcheckout[general][socila_login_style]" class="form-control">
   ...
   // });
              ...
              <tr id="payment_address_display_input" sort-data="-1">
               ...
               <td > 
                <label class="checkbox-inline" for="guest_payment_address_fields_display_display">
                 <input type="hidden" value="0" name="d_quickcheckout[option][guest][payment_address][display]" />
                 <?php if(isset($d_quickcheckout['option']['guest']['payment_address']['display']) && $d_quickcheckout['option']['guest']['payment_address']['display'] == 1){ ?>

                  <input type="checkbox" value="1" name="d_quickcheckout[option][guest][payment_address][display]" checked="checked" id="guest_payment_address_fields_display_display"/>

                 <?php }else{ ?>

                  <input type="checkbox" value="1" name="d_quickcheckout[option][guest][payment_address][display]" id="guest_payment_address_fields_display_display" />
               ...
               <td >
                <label class="checkbox-inline" for="register_payment_address_fields_display_display">
                 <input type="hidden" value="0" name="d_quickcheckout[option][register][payment_address][display]" />
                 <?php if(isset($d_quickcheckout['option']['register']['payment_address']['display']) && $d_quickcheckout['option']['register']['payment_address']['display'] == 1){ ?>
                  ...
                  <input type="checkbox" value="1" name="d_quickcheckout[option][register][payment_address][display]" checked="checked" id="register_payment_address_fields_display_display"/>

                 <?php }else{ ?>

                  <input type="checkbox" value="1" name="d_quickcheckout[option][register][payment_address][display]" id="register_payment_address_fields_display_display" />
               ...
               <td >
                <label class="checkbox-inline" for="logged_payment_address_fields_display_display">
                 <input type="hidden" value="0" name="d_quickcheckout[option][logged][payment_address][display]" />
                 <?php if(isset($d_quickcheckout['option']['logged']['payment_address']['display']) && $d_quickcheckout['option']['logged']['payment_address']['display'] == 1){ ?>
                  ...
                  <input type="checkbox" value="1" name="d_quickcheckout[option][logged][payment_address][display]" checked="checked" id="logged_payment_address_fields_display_display"/>

                 <?php }else{ ?>

                  <input type="checkbox" value="1" name="d_quickcheckout[option][logged][payment_address][display]" id="logged_payment_address_fields_display_display" />
              ...
              <tr id="payment_address_<?php echo $field['id']; ?>_input" 
                ...
                <span class="btn btn-link">
                 ...
                 <label>
                  ...
                  <input class="sort" 
                        ...
                        name="d_quickcheckout[step][payment_address][fields][<?php echo $field['id']; ?>][sort_order]" />
                 </label>
                ...
                <?php if(isset($d_quickcheckout['option']['guest']['payment_address']['fields'][$field['id']]['display'])) { ?>
                 ...
                 <label class="checkbox-inline" for="guest_payment_address_fields_<?php echo $field['id']; ?>_display">
                  <input type="hidden" value="0" name="d_quickcheckout[option][guest][payment_address][fields][<?php echo $field['id']; ?>][display]" />
                  <?php if(isset($d_quickcheckout['option']['guest']['payment_address']['fields'][$field['id']]['display']) && $d_quickcheckout['option']['guest']['payment_address']['fields'][$field['id']]['display'] == 1){ ?>
                   ...
                   <input type="checkbox" value="1" name="d_quickcheckout[option][guest][payment_address][fields][<?php echo $field['id']; ?>][display]" checked="checked" id="guest_payment_address_fields_<?php echo $field['id']; ?>_display"/>
                 
                  <?php }else{ ?>
              
                   <input type="checkbox" value="1" name="d_quickcheckout[option][guest][payment_address][fields][<?php echo $field['id']; ?>][display]" id="guest_payment_address_fields_<?php echo $field['id']; ?>_display" />
                ...
                <?php if(isset($d_quickcheckout['option']['guest']['payment_address']['fields'][$field['id']]['require'])) { ?>
                 <label class="checkbox-inline" for="guest_payment_address_fields_<?php echo $field['id']; ?>_require">
                  <input type="hidden" value="0" name="d_quickcheckout[option][guest][payment_address][fields][<?php echo $field['id']; ?>][require]" />
                  <?php if($d_quickcheckout['option']['guest']['payment_address']['fields'][$field['id']]['require'] == 1){ ?>

                   <input type="checkbox" value="1" name="d_quickcheckout[option][guest][payment_address][fields][<?php echo $field['id']; ?>][require]" checked="checked" id="guest_payment_address_fields_<?php echo $field['id']; ?>_require"/>
               
                  <?php }else{ ?>
              
                   <input type="checkbox" value="1" name="d_quickcheckout[option][guest][payment_address][fields][<?php echo $field['id']; ?>][require]" id="guest_payment_address_fields_<?php echo $field['id']; ?>_require" />
                ...
                <?php if(isset($d_quickcheckout['option']['register']['payment_address']['fields'][$field['id']]['display'])) { ?>
                 <label class="checkbox-inline" for="register_payment_address_fields_<?php echo $field['id']; ?>_display">
                  <input type="hidden" value="0" name="d_quickcheckout[option][register][payment_address][fields][<?php echo $field['id']; ?>][display]" />
                  <?php if(isset($d_quickcheckout['option']['register']['payment_address']['fields'][$field['id']]['display']) && $d_quickcheckout['option']['register']['payment_address']['fields'][$field['id']]['display'] == 1){ ?>
                   ...
                   <input type="checkbox" value="1" name="d_quickcheckout[option][register][payment_address][fields][<?php echo $field['id']; ?>][display]" checked="checked" id="register_payment_address_fields_<?php echo $field['id']; ?>_display"/>
             
                  <?php }else{ ?>
              
                   <input type="checkbox" value="1" name="d_quickcheckout[option][register][payment_address][fields][<?php echo $field['id']; ?>][display]" id="register_payment_address_fields_<?php echo $field['id']; ?>_display" />
                ...
                <?php if(isset($d_quickcheckout['option']['register']['payment_address']['fields'][$field['id']]['require'])) { ?>
                 <label class="checkbox-inline" for="register_payment_address_fields_<?php echo $field['id']; ?>_require">
                  <input type="hidden" value="0" name="d_quickcheckout[option][register][payment_address][fields][<?php echo $field['id']; ?>][require]" />

                  <?php if($d_quickcheckout['option']['register']['payment_address']['fields'][$field['id']]['require'] == 1){ ?>
                 
                   <input type="checkbox" value="1" name="d_quickcheckout[option][register][payment_address][fields][<?php echo $field['id']; ?>][require]" checked="checked" id="register_payment_address_fields_<?php echo $field['id']; ?>_require"/>
                  
                  <?php }else{ ?>
              
                   <input type="checkbox" value="1" name="d_quickcheckout[option][register][payment_address][fields][<?php echo $field['id']; ?>][require]" id="register_payment_address_fields_<?php echo $field['id']; ?>_require" />
                ...
                <?php if(isset($d_quickcheckout['option']['logged']['payment_address']['fields'][$field['id']]['display'])) { ?>
                 <label class="checkbox-inline" for="logged_payment_address_fields_<?php echo $field['id']; ?>_display">
                  <input type="hidden" value="0" name="d_quickcheckout[option][logged][payment_address][fields][<?php echo $field['id']; ?>][display]" />
                  <?php if(isset($d_quickcheckout['option']['logged']['payment_address']['fields'][$field['id']]['display']) && $d_quickcheckout['option']['logged']['payment_address']['fields'][$field['id']]['display'] == 1){ ?>
                   ...
                   <input type="checkbox" value="1" name="d_quickcheckout[option][logged][payment_address][fields][<?php echo $field['id']; ?>][display]" checked="checked" id="logged_payment_address_fields_<?php echo $field['id']; ?>_display"/>
             
                  <?php }else{ ?>
              
                   <input type="checkbox" value="1" name="d_quickcheckout[option][logged][payment_address][fields][<?php echo $field['id']; ?>][display]" id="logged_payment_address_fields_<?php echo $field['id']; ?>_display" />
                ...
                <?php if(isset($d_quickcheckout['option']['logged']['payment_address']['fields'][$field['id']]['require'])) { ?>
                 <label class="checkbox-inline" for="logged_payment_address_fields_<?php echo $field['id']; ?>_require">
                  <input type="hidden" value="0" name="d_quickcheckout[option][logged][payment_address][fields][<?php echo $field['id']; ?>][require]" />
                  <?php if($d_quickcheckout['option']['logged']['payment_address']['fields'][$field['id']]['require'] == 1){ ?>

                   <input type="checkbox" value="1" name="d_quickcheckout[option][logged][payment_address][fields][<?php echo $field['id']; ?>][require]" checked="checked" id="logged_payment_address_fields_<?php echo $field['id']; ?>_require"/>
             
                  <?php }else{ ?>
              
                   <input type="checkbox" value="1" name="d_quickcheckout[option][logged][payment_address][fields][<?php echo $field['id']; ?>][require]" id="logged_payment_address_fields_<?php echo $field['id']; ?>_require" />
                  ...
                  <tr id="shipping_address_display_input" >
                    ...
                    <td >
                      <label class="checkbox-inline" for="guest_shipping_address_display">
                       <input type="hidden" value="0" name="d_quickcheckout[option][guest][shipping_address][display]" />
                       <?php if(isset($d_quickcheckout['option']['guest']['shipping_address']['display']) && $d_quickcheckout['option']['guest']['shipping_address']['display'] == 1){ ?>
                        ...
                        <input type="checkbox" value="1" name="d_quickcheckout[option][guest][shipping_address][display]" checked="checked" id="guest_shipping_address_display"/>
                   
                       <?php }else{ ?>
                    
                        <input type="checkbox" value="1" name="d_quickcheckout[option][guest][shipping_address][display]" id="guest_shipping_address_display" />
                      ...
                      <label class="checkbox-inline" for="guest_shipping_address_require">
                       <input type="hidden" value="0" name="d_quickcheckout[option][guest][shipping_address][require]" />
                       <?php if(isset($d_quickcheckout['option']['guest']['shipping_address']['require']) && $d_quickcheckout['option']['guest']['shipping_address']['require'] == 1){ ?>
                        ...
                        <input type="checkbox" value="1" name="d_quickcheckout[option][guest][shipping_address][require]" checked="checked" id="guest_shipping_address_require"/>
                   
                       <?php }else{ ?>
                    
                        <input type="checkbox" value="1" name="d_quickcheckout[option][guest][shipping_address][require]" id="guest_shipping_address_require" />
                    ...
                    <td >
                      <label class="checkbox-inline" for="register_shipping_address_display">
                       <input type="hidden" value="0" name="d_quickcheckout[option][register][shipping_address][display]" />
                       <?php if(isset($d_quickcheckout['option']['register']['shipping_address']['display']) && $d_quickcheckout['option']['register']['shipping_address']['display'] == 1){ ?>
                        ...
                        <input type="checkbox" value="1" name="d_quickcheckout[option][register][shipping_address][display]" checked="checked" id="register_shipping_address_display"/>
                   
                       <?php }else{ ?>
                    
                        <input type="checkbox" value="1" name="d_quickcheckout[option][register][shipping_address][display]" id="register_shipping_address_display" />
                      ...
                      <label class="checkbox-inline" for="register_shipping_address_require">
                        <input type="hidden" value="0" name="d_quickcheckout[option][register][shipping_address][require]" />
                        <?php if(isset($d_quickcheckout['option']['register']['shipping_address']['require']) && $d_quickcheckout['option']['register']['shipping_address']['require'] == 1){ ?>
                          ...
                          <input type="checkbox" value="1" name="d_quickcheckout[option][register][shipping_address][require]" checked="checked" id="register_shipping_address_require"/>
                      
                        <?php }else{ ?>
                    
                          <input type="checkbox" value="1" name="d_quickcheckout[option][register][shipping_address][require]" id="register_shipping_address_require" />
                    ...
                    <td >
                      <label class="checkbox-inline" for="logged_shipping_address_display">
                        <input type="hidden" value="0" name="d_quickcheckout[option][logged][shipping_address][display]" />
                        <?php if(isset($d_quickcheckout['option']['logged']['shipping_address']['display']) && $d_quickcheckout['option']['logged']['shipping_address']['display'] == 1){ ?>
                          ...
                          <input type="checkbox" value="1" name="d_quickcheckout[option][logged][shipping_address][display]" checked="checked" id="logged_shipping_address_display"/>

                        <?php }else{ ?>

                          <input type="checkbox" value="1" name="d_quickcheckout[option][logged][shipping_address][display]" id="logged_shipping_address_display" />
                      ...
                      <label class="checkbox-inline" for="logged_shipping_address_require">
                        <input type="hidden" value="0" name="d_quickcheckout[option][logged][shipping_address][require]" />
                        <?php if(isset($d_quickcheckout['option']['logged']['shipping_address']['require']) && $d_quickcheckout['option']['logged']['shipping_address']['require'] == 1){ ?>
                          ...
                          <input type="checkbox" value="1" name="d_quickcheckout[option][logged][shipping_address][require]" checked="checked" id="logged_shipping_address_require"/>
                   
                        <?php }else{ ?>
                    
                          <input type="checkbox" value="1" name="d_quickcheckout[option][logged][shipping_address][require]" id="logged_shipping_address_require" />
              ...
              <?php foreach($d_quickcheckout['step']['shipping_address']['fields'] as $field){?>
                <tr id="shipping_address_<?php echo $field['id']; ?>_input" class="sort-item <?php echo ($field['type'] == 'system')? 'hide' : ''; ?>" sort-data="<?php echo (isset($d_quickcheckout['step']['shipping_address']['fields'][$field['id']]['sort_order']) ? $d_quickcheckout['step']['shipping_address']['fields'][$field['id']]['sort_order'] : ''); ?>">
                  <td class="name">
                    ...
                    <label>
                      <?php echo $field['title']; ?>
                      <input class="sort" type="hidden" value="<?php echo (isset($d_quickcheckout['step']['shipping_address']['fields'][$field['id']]['sort_order'])) ? $d_quickcheckout['step']['shipping_address']['fields'][$field['id']]['sort_order'] : ''; ?>" name="d_quickcheckout[step][shipping_address][fields][<?php echo $field['id']; ?>][sort_order]" />
                    </label>
                  </td>
                  <td >
                  <?php if(isset($d_quickcheckout['option']['guest']['shipping_address']['fields'][$field['id']]['display'])) { ?>
                    <label class="checkbox-inline" for="guest_shipping_address_fields_<?php echo $field['id']; ?>_display">
                      <input type="hidden" value="0" name="d_quickcheckout[option][guest][shipping_address][fields][<?php echo $field['id']; ?>][display]" />
                      <?php if(isset($d_quickcheckout['option']['guest']['shipping_address']['fields'][$field['id']]['display']) && $d_quickcheckout['option']['guest']['shipping_address']['fields'][$field['id']]['display'] == 1){ ?>
                        ...
                        <input type="checkbox" value="1" name="d_quickcheckout[option][guest][shipping_address][fields][<?php echo $field['id']; ?>][display]" checked="checked" id="guest_shipping_address_fields_<?php echo $field['id']; ?>_display"/>
                    
                        <?php }else{ ?>
                        
                          <input type="checkbox" value="1" name="d_quickcheckout[option][guest][shipping_address][fields][<?php echo $field['id']; ?>][display]" id="guest_shipping_address_fields_<?php echo $field['id']; ?>_display" />
                      ...
                      <?php if(isset($d_quickcheckout['option']['guest']['shipping_address']['fields'][$field['id']]['require'])) { ?>
                        <label class="checkbox-inline" for="guest_shipping_address_fields_<?php echo $field['id']; ?>_require">
                          <input type="hidden" value="0" name="d_quickcheckout[option][guest][shipping_address][fields][<?php echo $field['id']; ?>][require]" />
                          <?php if($d_quickcheckout['option']['guest']['shipping_address']['fields'][$field['id']]['require'] == 1){ ?>

                            <input type="checkbox" value="1" name="d_quickcheckout[option][guest][shipping_address][fields][<?php echo $field['id']; ?>][require]" checked="checked" id="guest_shipping_address_fields_<?php echo $field['id']; ?>_require"/>
             
                          <?php }else{ ?>
                  
                            <input type="checkbox" value="1" name="d_quickcheckout[option][guest][shipping_address][fields][<?php echo $field['id']; ?>][require]" id="guest_shipping_address_fields_<?php echo $field['id']; ?>_require" />
                      ...
                      <?php if(isset($d_quickcheckout['option']['register']['shipping_address']['fields'][$field['id']]['display'])) { ?>
                        <label class="checkbox-inline" for="register_shipping_address_fields_<?php echo $field['id']; ?>_display">
                          <input type="hidden" value="0" name="d_quickcheckout[option][register][shipping_address][fields][<?php echo $field['id']; ?>][display]" />
                          <?php if($d_quickcheckout['option']['register']['shipping_address']['fields'][$field['id']]['display'] == 1){ ?>
                            
                            <input type="checkbox" value="1" name="d_quickcheckout[option][register][shipping_address][fields][<?php echo $field['id']; ?>][display]" checked="checked" id="register_shipping_address_fields_<?php echo $field['id']; ?>_display"/>
               
                          <?php }else{ ?>
                
                            <input type="checkbox" value="1" name="d_quickcheckout[option][register][shipping_address][fields][<?php echo $field['id']; ?>][display]" id="register_shipping_address_fields_<?php echo $field['id']; ?>_display" />
                      ...
                      <?php if(isset($d_quickcheckout['option']['register']['shipping_address']['fields'][$field['id']]['require'])) { ?>
                        <label class="checkbox-inline" for="register_shipping_address_fields_<?php echo $field['id']; ?>_require">
                          <input type="hidden" value="0" name="d_quickcheckout[option][register][shipping_address][fields][<?php echo $field['id']; ?>][require]" />
                          <?php if($d_quickcheckout['option']['register']['shipping_address']['fields'][$field['id']]['require'] == 1){ ?>
                
                            <input type="checkbox" value="1" name="d_quickcheckout[option][register][shipping_address][fields][<?php echo $field['id']; ?>][require]" checked="checked" id="register_shipping_address_fields_<?php echo $field['id']; ?>_require"/>
                      
                          <?php }else{ ?>
                
                            <input type="checkbox" value="1" name="d_quickcheckout[option][register][shipping_address][fields][<?php echo $field['id']; ?>][require]" id="register_shipping_address_fields_<?php echo $field['id']; ?>_require" />
                      ...
                      <?php if(isset($d_quickcheckout['option']['logged']['shipping_address']['fields'][$field['id']]['display'])) { ?>
                        <label class="checkbox-inline" for="logged_shipping_address_fields_<?php echo $field['id']; ?>_display">
                          <input type="hidden" value="0" name="d_quickcheckout[option][logged][shipping_address][fields][<?php echo $field['id']; ?>][display]" />
                          <?php if(isset($d_quickcheckout['option']['logged']['shipping_address']['fields'][$field['id']]['display']) && $d_quickcheckout['option']['logged']['shipping_address']['fields'][$field['id']]['display'] == 1){ ?>
                            ...
                            <input type="checkbox" value="1" name="d_quickcheckout[option][logged][shipping_address][fields][<?php echo $field['id']; ?>][display]" checked="checked" id="logged_shipping_address_fields_<?php echo $field['id']; ?>_display"/>
                      
                          <?php }else{ ?>
              
                            <input type="checkbox" value="1" name="d_quickcheckout[option][logged][shipping_address][fields][<?php echo $field['id']; ?>][display]" id="logged_shipping_address_fields_<?php echo $field['id']; ?>_display" />
                      ...
                      <?php if(isset($d_quickcheckout['option']['logged']['shipping_address']['fields'][$field['id']]['require'])) { ?>
                        <label class="checkbox-inline" for="logged_shipping_address_fields_<?php echo $field['id']; ?>_require">
                          <input type="hidden" value="0" name="d_quickcheckout[option][logged][shipping_address][fields][<?php echo $field['id']; ?>][require]" />
                          <?php if($d_quickcheckout['option']['logged']['shipping_address']['fields'][$field['id']]['require'] == 1){ ?>

                            <input type="checkbox" value="1" name="d_quickcheckout[option][logged][shipping_address][fields][<?php echo $field['id']; ?>][require]" checked="checked" id="logged_shipping_address_fields_<?php echo $field['id']; ?>_require"/>
              
                          <?php }else{ ?>
              
                            <input type="checkbox" value="1" name="d_quickcheckout[option][logged][shipping_address][fields][<?php echo $field['id']; ?>][require]" id="logged_shipping_address_fields_<?php echo $field['id']; ?>_require" />
         ...
         <div id="shipping_method" class="tab-pane">
              ...
              <div class="col-sm-9">
                <div class="checkbox">
                  <label for="shipping_method_display">
                    <input type="hidden" value="0" name="d_quickcheckout[step][shipping_method][display]" />
                    <?php if(isset($d_quickcheckout['step']['shipping_method']['display']) && $d_quickcheckout['step']['shipping_method']['display'] == 1){ ?>
                      
                      <input type="checkbox" value="1" name="d_quickcheckout[step][shipping_method][display]" checked="checked" id="shipping_method_display" />
             
                    <?php }else{ ?>
             
                      <input type="checkbox" value="1" name="d_quickcheckout[step][shipping_method][display]" id="shipping_method_display" />
              ...
              <div class="col-sm-9">
                <div class="checkbox">
                  <label for="shipping_method_display_options">  
                    <input type="hidden" value="0" name="d_quickcheckout[step][shipping_method][display_options]" />
                    <?php if(isset($d_quickcheckout['step']['shipping_method']['display']) && $d_quickcheckout['step']['shipping_method']['display_options'] == 1){ ?>

                      <input type="checkbox" value="1" name="d_quickcheckout[step][shipping_method][display_options]" checked="checked" id="shipping_method_display_options" />
                     
                     <?php }else{ ?>

                      <input type="checkbox" value="1" name="d_quickcheckout[step][shipping_method][display_options]" id="shipping_method_display_options" />
              ...
              <div class="col-sm-9">
                <div class="checkbox">
                  <label for="shipping_method_display_title">  
                    <input type="hidden" value="0" name="d_quickcheckout[step][shipping_method][display_title]" />
                    <?php if(isset($d_quickcheckout['step']['shipping_method']['display']) && $d_quickcheckout['step']['shipping_method']['display_title'] == 1){ ?>
             
                      <input type="checkbox" value="1" name="d_quickcheckout[step][shipping_method][display_title]" checked="checked" id="shipping_method_display_title" />
             
                    <?php }else{ ?>
              
                      <input type="checkbox" value="1" name="d_quickcheckout[step][shipping_method][display_title]" id="shipping_method_display_title" />
              ...
              <div class="col-sm-9">
                <div class="radio">
                  ...
                  <?php }else{ ?>
                    ...
                    <label for="shipping_method_input_style_radio" class="radio-inline">
                      <input type="radio" value="radio" name="d_quickcheckout[step][shipping_method][input_style]" id="shipping_method_input_style_radio" />
                      <?php echo $text_input_radio; ?>
                    </label>

                    <label for="shipping_method_input_style_select" class="radio-inline">
                      <input type="radio" value="select" name="d_quickcheckout[step][shipping_method][input_style]" checked="checked" id="shipping_method_input_style_select" />
                      <?php echo $text_input_select; ?>
                    </label>
            ...
            <div class="form-group">
              ...
              <div class="col-sm-9">
                <select name="d_quickcheckout[step][shipping_method][default_option]" class="form-control">
         ...
         <div id="payment_method" class="tab-pane">
              ...
              <div class="col-sm-9">
                <div class="checkbox">
                  <label for="payment_method_display">
                    <input type="hidden" value="0" name="d_quickcheckout[step][payment_method][display]" />
                    <?php if(isset($d_quickcheckout['step']['payment_method']['display']) && $d_quickcheckout['step']['payment_method']['display'] == 1){ ?>

                      <input type="checkbox" value="1" name="d_quickcheckout[step][payment_method][display]" checked="checked" id="payment_method_display" />
             
                    <?php }else{ ?>
             
                      <input type="checkbox" value="1" name="d_quickcheckout[step][payment_method][display]" id="payment_method_display" />
              ...
              <div class="col-sm-9">
                <div class="checkbox">
                  <label for="payment_method_display_options">
                    <input type="hidden" value="0" name="d_quickcheckout[step][payment_method][display_options]" />
                    <?php if(isset($d_quickcheckout['step']['payment_method']['display']) && $d_quickcheckout['step']['payment_method']['display_options'] == 1){ ?>

                      <input type="checkbox" value="1" name="d_quickcheckout[step][payment_method][display_options]" checked="checked" id="payment_method_display_options" />
             
                    <?php }else{ ?>
             
                      <input type="checkbox" value="1" name="d_quickcheckout[step][payment_method][display_options]" id="payment_method_display_options" />
                ...
                <div class="radio">
                  <?php if(isset($d_quickcheckout['step']['payment_method']['input_style']) && $d_quickcheckout['step']['payment_method']['input_style'] == 'radio'){ ?>
                    ...
                    <label for="payment_method_input_style_radio" class="radio-inline">
                      <input type="radio" value="radio" name="d_quickcheckout[step][payment_method][input_style]" checked="checked" id="payment_method_input_style_radio" />
                      <?php echo $text_input_radio; ?>
                    </label>

                    <label for="payment_method_input_style_select" class="radio-inline">
                      <input type="radio" value="select" name="d_quickcheckout[step][payment_method][input_style]" id="payment_method_input_style_select" />
                      <?php echo $text_input_select; ?>
                    </label>
                  ...
                  <?php }else{ ?>
                    ...
                    <label for="payment_method_input_style_radio" class="radio-inline">
                      <input type="radio" value="radio" name="d_quickcheckout[step][payment_method][input_style]" id="payment_method_input_style_radio" />
                      <?php echo $text_input_radio; ?>
                    </label>

                    <label for="payment_method_input_style_select" class="radio-inline">
                      <input type="radio" value="select" name="d_quickcheckout[step][payment_method][input_style]" checked="checked" id="payment_method_input_style_select" />
                      <?php echo $text_input_select; ?>
                    </label>
              ...
              <div class="col-sm-9">
                <div class="checkbox">
                  <label for="payment_method_display_images">
                    <input type="hidden" value="0" name="d_quickcheckout[step][payment_method][display_images]" />
                    <?php if(isset($d_quickcheckout['step']['payment_method']['display']) && $d_quickcheckout['step']['payment_method']['display_images'] == 1){ ?>
             
                      <input type="checkbox" value="1" name="d_quickcheckout[step][payment_method][display_images]" checked="checked" id="payment_method_display_images" />
             
                    <?php }else{ ?>
             
                      <input type="checkbox" value="1" name="d_quickcheckout[step][payment_method][display_images]" id="payment_method_display_images" />
            ...
            <div class="form-group">
              ...
              <div class="col-sm-9">
                <select name="d_quickcheckout[step][payment_method][default_option]" class="form-control">
                  ...
                  <tr>
                    ...
                    <td>
                      <label for="option_guest_cart_display" class="checkbox-inline">
                        <input type="hidden" value="0" name="d_quickcheckout[option][guest][cart][display]" />
                        <?php if(isset($d_quickcheckout['option']['guest']['cart']['display']) && $d_quickcheckout['option']['guest']['cart']['display'] == 1){ ?>
                
                          <input type="checkbox" value="1" name="d_quickcheckout[option][guest][cart][display]" checked="checked" id="option_guest_cart_display" />

                        <?php }else{ ?>
             
                          <input type="checkbox" value="1" name="d_quickcheckout[option][guest][cart][display]" id="option_guest_cart_display" />
                    ...
                    <td>
                      <label for="option_register_cart_display" class="checkbox-inline">
                        <input type="hidden" value="0" name="d_quickcheckout[option][register][cart][display]" />
                        <?php if(isset($d_quickcheckout['option']['register']['cart']['display']) && $d_quickcheckout['option']['register']['cart']['display'] == 1){ ?>
             
                          <input type="checkbox" value="1" name="d_quickcheckout[option][register][cart][display]" checked="checked" id="option_register_cart_display" />

                        <?php }else{ ?>
             
                          <input type="checkbox" value="1" name="d_quickcheckout[option][register][cart][display]" id="option_register_cart_display" />
                    ...
                    <td>
                      <label for="option_logged_cart_display" class="checkbox-inline">
                        <input type="hidden" value="0" name="d_quickcheckout[option][logged][cart][display]" />
                        <?php if(isset($d_quickcheckout['option']['logged']['cart']['display']) && $d_quickcheckout['option']['logged']['cart']['display'] == 1){ ?>
              
                          <input type="checkbox" value="1" name="d_quickcheckout[option][logged][cart][display]" checked="checked" id="option_logged_cart_display" />

                        <?php }else{ ?>
                      
                          <input type="checkbox" value="1" name="d_quickcheckout[option][logged][cart][display]" id="option_logged_cart_display" />
                  ...
                  <tr>
                    ...
                    <td>
                      <label for="option_guest_cart_columns_<?php echo $field; ?>" class="checkbox-inline">
                        <input type="hidden" value="0" name="d_quickcheckout[option][guest][cart][columns][<?php echo $field; ?>]" />
                        <?php if(isset($d_quickcheckout['option']['guest']['cart']['columns'][$field]) && $d_quickcheckout['option']['guest']['cart']['columns'][$field] == 1){ ?>
             
                          <input type="checkbox" value="1" name="d_quickcheckout[option][guest][cart][columns][<?php echo $field; ?>]" checked="checked" id="option_guest_cart_columns_<?php echo $field; ?>" />

                        <?php }else{ ?>
                        
                          <input type="checkbox" value="1" name="d_quickcheckout[option][guest][cart][columns][<?php echo $field; ?>]" id="option_guest_cart_columns_<?php echo $field; ?>"/>
                    ...
                    <td>
                      <label for="option_register_cart_columns_<?php echo $field; ?>" class="checkbox-inline">
                        <input type="hidden" value="0" name="d_quickcheckout[option][register][cart][columns][<?php echo $field; ?>]" />
                        <?php if(isset($d_quickcheckout['option']['register']['cart']['columns'][$field]) && $d_quickcheckout['option']['register']['cart']['columns'][$field] == 1){ ?>
             
                          <input type="checkbox" value="1" name="d_quickcheckout[option][register][cart][columns][<?php echo $field; ?>]" checked="checked" id="option_register_cart_columns_<?php echo $field; ?>" />

                        <?php }else{ ?>
                
                          <input type="checkbox" value="1" name="d_quickcheckout[option][register][cart][columns][<?php echo $field; ?>]" id="option_register_cart_columns_<?php echo $field; ?>" />
                    ...
                    <td>
                      <label for="option_logged_cart_columns_<?php echo $field; ?>" class="checkbox-inline">
                        <input type="hidden" value="0" name="d_quickcheckout[option][logged][cart][columns][<?php echo $field; ?>]" />
                        <?php if(isset($d_quickcheckout['option']['logged']['cart']['columns'][$field]) && $d_quickcheckout['option']['logged']['cart']['columns'][$field] == 1){ ?>
             
                          <input type="checkbox" value="1" name="d_quickcheckout[option][logged][cart][columns][<?php echo $field; ?>]" checked="checked" id="option_logged_cart_columns_<?php echo $field; ?>" />

                        <?php }else{ ?>
             
                          <input type="checkbox" value="1" name="d_quickcheckout[option][logged][cart][columns][<?php echo $field; ?>]" id="option_logged_cart_columns_<?php echo $field; ?>" />
                  ...
                  <tr>
                    ...
                    <td>
                      <label for="option_guest_cart_option_<?php echo $field; ?>_display" class="checkbox-inline">
                        <input type="hidden" value="0" name="d_quickcheckout[option][guest][cart][option][<?php echo $field; ?>][display]" />
                        <?php if(isset($d_quickcheckout['option']['guest']['cart']['option'][$field]['display']) && $d_quickcheckout['option']['guest']['cart']['option'][$field]['display'] == 1){ ?>
                          ...
                          <input type="checkbox" value="1" name="d_quickcheckout[option][guest][cart][option][<?php echo $field; ?>][display]" checked="checked" id="option_guest_cart_option_<?php echo $field; ?>_display" />

                        <?php }else{ ?>
             
                          <input type="checkbox" value="1" name="d_quickcheckout[option][guest][cart][option][<?php echo $field; ?>][display]" id="option_guest_cart_option_<?php echo $field; ?>_display"/>
                    ...
                    <td>
                      <label for="option_register_cart_option_<?php echo $field; ?>_display" class="checkbox-inline">
                        <input type="hidden" value="0" name="d_quickcheckout[option][register][cart][option][<?php echo $field; ?>][display]" />
                        <?php if(isset($d_quickcheckout['option']['register']['cart']['option'][$field]['display']) && $d_quickcheckout['option']['register']['cart']['option'][$field]['display'] == 1){ ?>
                          ...
                          <input type="checkbox" value="1" name="d_quickcheckout[option][register][cart][option][<?php echo $field; ?>][display]" checked="checked" id="option_register_cart_option_<?php echo $field; ?>_display" />

                        <?php }else{ ?>
                
                          <input type="checkbox" value="1" name="d_quickcheckout[option][register][cart][option][<?php echo $field; ?>][display]" id="option_register_cart_option_<?php echo $field; ?>_display" />
                    ...
                    <td>
                      <label for="option_logged_cart_option_<?php echo $field; ?>_display" class="checkbox-inline">
                        <input type="hidden" value="0" name="d_quickcheckout[option][logged][cart][option][<?php echo $field; ?>][display]" />
                        <?php if(isset($d_quickcheckout['option']['logged']['cart']['option'][$field]['display']) && $d_quickcheckout['option']['logged']['cart']['option'][$field]['display'] == 1){ ?>
                          ...
                          <input type="checkbox" value="1" name="d_quickcheckout[option][logged][cart][option][<?php echo $field; ?>][display]" checked="checked" id="option_logged_cart_option_<?php echo $field; ?>_display" />

                        <?php }else{ ?>
             
                          <input type="checkbox" value="1" name="d_quickcheckout[option][logged][cart][option][<?php echo $field; ?>][display]" id="option_logged_cart_option_<?php echo $field; ?>_display" />
                ...
                <?php foreach($d_quickcheckout['step']['confirm']['fields'] as $field){?>
                  <tr id="confirm_<?php echo $field['id']; ?>_input" class="sort-item <?php echo ($field['type'] == 'system')? 'hide' : ''; ?>" sort-data="<?php echo (isset($d_quickcheckout['step']['confirm']['fields'][$field['id']]['sort_order']) ? $d_quickcheckout['step']['confirm']['fields'][$field['id']]['sort_order'] : ''); ?>">
                    <td class="name">
                      ...
                      <label>
                        <?php echo $field['title']; ?>
                        <input class="sort" type="hidden" value="<?php echo (isset($d_quickcheckout['step']['confirm']['fields'][$field['id']]['sort_order'])) ? $d_quickcheckout['step']['confirm']['fields'][$field['id']]['sort_order'] : ''; ?>" name="d_quickcheckout[step][confirm][fields][<?php echo $field['id']; ?>][sort_order]" />
                      </label>
                    </td>
                    ...
                    <?php if(isset($d_quickcheckout['option']['guest']['confirm']['fields'][$field['id']]['display'])) { ?>
                      <label for="guest_confirm_fields_<?php echo $field['id']; ?>_display" class="checkbox-inline">
                        <input type="hidden" value="0" name="d_quickcheckout[option][guest][confirm][fields][<?php echo $field['id']; ?>][display]" />
                        <?php if(isset($d_quickcheckout['option']['guest']['confirm']['fields'][$field['id']]['display']) && $d_quickcheckout['option']['guest']['confirm']['fields'][$field['id']]['display'] == 1){ ?>
                          ...
                          <input type="checkbox" value="1" name="d_quickcheckout[option][guest][confirm][fields][<?php echo $field['id']; ?>][display]" checked="checked" id="guest_confirm_fields_<?php echo $field['id']; ?>_display"/>
                        
                        <?php }else{ ?>
                        
                          <input type="checkbox" value="1" name="d_quickcheckout[option][guest][confirm][fields][<?php echo $field['id']; ?>][display]" id="guest_confirm_fields_<?php echo $field['id']; ?>_display" />
                        <?php } ?>
                        <?php echo $text_display; ?>
                      </label>
                    ...
                    <?php if(isset($d_quickcheckout['option']['guest']['confirm']['fields'][$field['id']]['require'])) { ?>
                      <label for="guest_confirm_fields_<?php echo $field['id']; ?>_require" class="checkbox-inline">
                        <input type="hidden" value="0" name="d_quickcheckout[option][guest][confirm][fields][<?php echo $field['id']; ?>][require]" />
                        <?php if($d_quickcheckout['option']['guest']['confirm']['fields'][$field['id']]['require'] == 1){ ?>
                  
                          <input type="checkbox" value="1" name="d_quickcheckout[option][guest][confirm][fields][<?php echo $field['id']; ?>][require]" checked="checked" id="guest_confirm_fields_<?php echo $field['id']; ?>_require"/>
                        
                        <?php }else{ ?>
              
                          <input type="checkbox" value="1" name="d_quickcheckout[option][guest][confirm][fields][<?php echo $field['id']; ?>][require]" id="guest_confirm_fields_<?php echo $field['id']; ?>_require" />
                    ...
                    <?php if(isset($d_quickcheckout['option']['register']['confirm']['fields'][$field['id']]['display'])) { ?>
                      <label for="register_confirm_fields_<?php echo $field['id']; ?>_display" class="checkbox-inline">
                        <input type="hidden" value="0" name="d_quickcheckout[option][register][confirm][fields][<?php echo $field['id']; ?>][display]" />
                        <?php if(isset($d_quickcheckout['option']['register']['confirm']['fields'][$field['id']]['display']) && $d_quickcheckout['option']['register']['confirm']['fields'][$field['id']]['display'] == 1){ ?>
                          ...
                          <input type="checkbox" value="1" name="d_quickcheckout[option][register][confirm][fields][<?php echo $field['id']; ?>][display]" checked="checked" id="register_confirm_fields_<?php echo $field['id']; ?>_display"/>
                        
                        <?php }else{ ?>
                          
                          <input type="checkbox" value="1" name="d_quickcheckout[option][register][confirm][fields][<?php echo $field['id']; ?>][display]" id="register_confirm_fields_<?php echo $field['id']; ?>_display" />
                    ...
                    <?php if(isset($d_quickcheckout['option']['register']['confirm']['fields'][$field['id']]['require'])) { ?>
                      <label for="register_confirm_fields_<?php echo $field['id']; ?>_require" class="checkbox-inline">
                        <input type="hidden" value="0" name="d_quickcheckout[option][register][confirm][fields][<?php echo $field['id']; ?>][require]" />
                        <?php if($d_quickcheckout['option']['register']['confirm']['fields'][$field['id']]['require'] == 1){ ?>
                  
                          <input type="checkbox" value="1" name="d_quickcheckout[option][register][confirm][fields][<?php echo $field['id']; ?>][require]" checked="checked" id="register_confirm_fields_<?php echo $field['id']; ?>_require"/>
               
                        <?php }else{ ?>
                    
                          <input type="checkbox" value="1" name="d_quickcheckout[option][register][confirm][fields][<?php echo $field['id']; ?>][require]" id="register_confirm_fields_<?php echo $field['id']; ?>_require" />
                    ...
                    <?php if(isset($d_quickcheckout['option']['logged']['confirm']['fields'][$field['id']]['display'])) { ?>
                      <label for="logged_confirm_fields_<?php echo $field['id']; ?>_display" class="checkbox-inline">
                        <input type="hidden" value="0" name="d_quickcheckout[option][logged][confirm][fields][<?php echo $field['id']; ?>][display]" />
                        <?php if(isset($d_quickcheckout['option']['logged']['confirm']['fields'][$field['id']]['display']) && $d_quickcheckout['option']['logged']['confirm']['fields'][$field['id']]['display'] == 1){ ?>
                          ...
                          <input type="checkbox" value="1" name="d_quickcheckout[option][logged][confirm][fields][<?php echo $field['id']; ?>][display]" checked="checked" id="logged_confirm_fields_<?php echo $field['id']; ?>_display"/>
                        
                        <?php }else{ ?>
                      
                          <input type="checkbox" value="1" name="d_quickcheckout[option][logged][confirm][fields][<?php echo $field['id']; ?>][display]" id="logged_confirm_fields_<?php echo $field['id']; ?>_display" />
                    ...
                    <?php if(isset($d_quickcheckout['option']['logged']['confirm']['fields'][$field['id']]['require'])) { ?>
                      <label for="logged_confirm_fields_<?php echo $field['id']; ?>_require" class="checkbox-inline">
                        <input type="hidden" value="0" name="d_quickcheckout[option][logged][confirm][fields][<?php echo $field['id']; ?>][require]" />
                        <?php if($d_quickcheckout['option']['logged']['confirm']['fields'][$field['id']]['require'] == 4){ ?>
                        
                          <input type="checkbox" value="4" name="d_quickcheckout[option][logged][confirm][fields][<?php echo $field['id']; ?>][require]" checked="checked" id="logged_confirm_fields_<?php echo $field['id']; ?>_require"/>
                      
                        <?php }else{ ?>
                        
                          <input type="checkbox" value="4" name="d_quickcheckout[option][logged][confirm][fields][<?php echo $field['id']; ?>][require]" id="logged_confirm_fields_<?php echo $field['id']; ?>_require" />
         ...
         <div id="design" class="tab-pane">
           ...
           <div class="form-group hidden">
              ...
              <div class="col-sm-9">
                <select name="d_quickcheckout[design][theme]" class="form-control">
              ...
              <div class="col-sm-9">
                <?php if(isset($d_quickcheckout['design']['block_style']) && $d_quickcheckout['design']['block_style'] == 'row'){ ?>
                  <label for="block_style_row" class="radio-inline">
                    <input type="radio" value="row" name="d_quickcheckout[design][block_style]" checked="checked" id="block_style_row" />
                    <?php echo $text_row; ?>
                  </label>
                  <label for="block_style_block" class="radio-inline">
                    <input type="radio" value="block" name="d_quickcheckout[design][block_style]" id="block_style_block" />
                    <?php echo $text_block; ?>
                  </label>
                <?php }else{ ?>
                  <label for="block_style_row" class="radio-inline">
                    <input type="radio" value="row" name="d_quickcheckout[design][block_style]" id="block_style_row" />
                    <?php echo $text_row; ?>
                  </label>
                  <label for="block_style_block" class="radio-inline">
                    <input type="radio" value="block" name="d_quickcheckout[design][block_style]" checked="checked" id="block_style_block"/>
                    <?php echo $text_block; ?>
                  </label>
                <?php } ?>
              </div>
            ...
            <div class="form-group">
              ...
              <div class="col-sm-9">
                <label for="step_login_option_login_display" class="checkbox-inline">
                  <input type="hidden" value="0" name="d_quickcheckout[step][login][option][login][display]" />
                  <?php if(isset($d_quickcheckout['step']['login']['option']['login']['display']) && $d_quickcheckout['step']['login']['option']['login']['display'] == 1){ ?>
                    
                    <input type="checkbox" value="1" name="d_quickcheckout[step][login][option][login][display]" checked="checked" id="step_login_option_login_display"/>
            
                  <?php }else{ ?>
            
                    <input type="checkbox" value="1" name="d_quickcheckout[step][login][option][login][display]" id="step_login_option_login_display" />
                ...
                <label for="step_login_option_register_display" class="checkbox-inline">
                  <input type="hidden" value="0" name="d_quickcheckout[step][login][option][register][display]" />
                  <?php if(isset($d_quickcheckout['step']['login']['option']['register']['display']) && $d_quickcheckout['step']['login']['option']['register']['display'] == 1){ ?>
                  
                    <input type="checkbox" value="1" name="d_quickcheckout[step][login][option][register][display]" checked="checked" id="step_login_option_register_display"/>
            
                  <?php }else{ ?>
            
                    <input type="checkbox" value="1" name="d_quickcheckout[step][login][option][register][display]" id="step_login_option_register_display" />
                ...
                <label for="step_login_option_guest_display" class="checkbox-inline">
                  <input type="hidden" value="0" name="d_quickcheckout[step][login][option][guest][display]" />
                  <?php if(isset($d_quickcheckout['step']['login']['option']['guest']['display']) && $d_quickcheckout['step']['login']['option']['guest']['display'] == 1){ ?>
            
                    <input type="checkbox" value="1" name="d_quickcheckout[step][login][option][guest][display]" checked="checked" id="step_login_option_guest_display"/>
            
                  <?php }else{ ?>
            
                    <input type="checkbox" value="1" name="d_quickcheckout[step][login][option][guest][display]" id="step_login_option_guest_display" />
            ...
            <div class="form-group">
              ...
              <?php if(isset($d_quickcheckout['design']['login_style']) && $d_quickcheckout['design']['login_style'] == 'block'){ ?>
                <label for="login_style_block" class="radio-inline">
                  <input type="radio" value="block" name="d_quickcheckout[design][login_style]" checked="checked" id="login_style_block" />
                  <?php echo $text_block; ?>
                </label>
                <label for="login_style_popup" class="radio-inline">
                  <input type="radio" value="popup" name="d_quickcheckout[design][login_style]" id="login_style_popup" />
                  <?php echo $text_popup; ?>
                </label>
              <?php }else{ ?>
                <label for="login_style_block" class="radio-inline">
                  <input type="radio" value="block" name="d_quickcheckout[design][login_style]" id="login_style_block" />
                  <?php echo $text_block; ?>
                </label>
                <label for="login_style_popup" class="radio-inline">
                  <input type="radio" value="popup" name="d_quickcheckout[design][login_style]" checked="checked" id="login_style_popup"/>
                  <?php echo $text_popup; ?>
                </label>
              <?php } ?>
              </div>
            ...
            <div class="form-group">
              ...
              <?php if(isset($d_quickcheckout['design']['address_style']) && $d_quickcheckout['design']['address_style'] == 'radio'){ ?>
                <label for="address_style_radio" class="radio-inline">
                  <input type="radio" value="radio" name="d_quickcheckout[design][address_style]" checked="checked" id="address_style_radio" />
                  <?php echo $text_input_radio; ?>
                </label>
                <label for="address_style_select" class="radio-inline">
                  <input type="radio" value="select" name="d_quickcheckout[design][address_style]" id="address_style_select" />
                  <?php echo $text_input_select; ?>
                </label>
              <?php }else{ ?>
                <label for="address_style_radio" class="radio-inline">
                  <input type="radio" value="radio" name="d_quickcheckout[design][address_style]" id="address_style_radio" />
                  <?php echo $text_input_radio; ?>
                </label>
                <label for="address_style_select" class="radio-inline">
                  <input type="radio" value="select" name="d_quickcheckout[design][address_style]" checked="checked" id="address_style_select"/>
                  <?php echo $text_input_select; ?>
                </label>
              <?php } ?>
              </div>
              ...
              <div class="col-sm-9">
                <div class="form-inline" role="form">
                  <div class="input-group">
                    ...
                    <input id="cart_image_size_width" name="d_quickcheckout[design][cart_image_size][width]" value="<?php echo (isset($d_quickcheckout['design']['cart_image_size']['width'])) ? $d_quickcheckout['design']['cart_image_size']['width'] : '150'; ?>" class="form-control"/>
                  </div>
                  <div class="input-group">
                    <label for="cart_image_size_height" class="input-group-addon"><?php echo $text_height; ?></label>
                    <input id="cart_image_size_height" name="d_quickcheckout[design][cart_image_size][height]" value="<?php echo (isset($d_quickcheckout['design']['cart_image_size']['height'])) ? $d_quickcheckout['design']['cart_image_size']['height'] : '150'; ?>" class="form-control"/>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div class="form-group">
              ...
              <div class="col-sm-9">
                <div class="form-inline" role="form">
                  <div class="input-group">
                    <input id="max_width" name="d_quickcheckout[design][max_width]" value="<?php echo (isset($d_quickcheckout['design']['max_width'])) ? $d_quickcheckout['design']['max_width'] : '960'; ?>" class="form-control" />
              ...
              <div class="col-sm-9">
               <div class="checkbox">
                <label for="design_uniform">
                  <input type="hidden" value="0" name="d_quickcheckout[design][uniform]" />
                  <input type="checkbox" value="1" name="d_quickcheckout[design][uniform]" <?php echo (isset($d_quickcheckout['design']['uniform']) && $d_quickcheckout['design']['uniform'])? 'checked="checked"' : ''; ?> id="design_uniform" />
                  <?php echo $text_enable; ?>
                </label>
               </div>
              </div>
              ...
              <div class="col-sm-9">
               <div class="checkbox">
                <label for="design_only_quickcheckout">
                  <input type="hidden" value="0" name="d_quickcheckout[design][only_quickcheckout]" />
                  <input type="checkbox" value="1" name="d_quickcheckout[design][only_quickcheckout]" <?php echo (isset($d_quickcheckout['design']['only_quickcheckout']) && $d_quickcheckout['design']['only_quickcheckout'])? 'checked="checked"' : ''; ?> id="design_only_quickcheckout" />
                  <?php echo $text_enable; ?>
                </label>
               </div>
              </div>
              ...
              <div class="col-sm-9">
                <div id="column_design" style="position:static; ">
                  ...
                  <div class="column-width-group">
                    <input id="column_width_1" type="text" class="column-width" name="d_quickcheckout[design][column_width][1]" value="<?php echo $d_quickcheckout['design']['column_width'][1]; ?>" 
                    /><input id="column_width_2" type="text" class="column-width" name="d_quickcheckout[design][column_width][2]" value="<?php echo $d_quickcheckout['design']['column_width'][2]; ?>" 
                    /><input id="column_width_3" type="text" class="column-width" name="d_quickcheckout[design][column_width][3]" value="<?php echo $d_quickcheckout['design']['column_width'][3]; ?>" 
                    /><input id="column_width_4" type="hidden" class="column-width" name="d_quickcheckout[design][column_width][4]" value="<?php echo $d_quickcheckout['design']['column_width'][4]; ?>" />
                  </div >
                      ...
                      <li class="portlet" id="step_<?php echo $step; ?>" data-column="<?php echo $d_quickcheckout['step'][$step]['column']; ?>" data-row="<?php echo $d_quickcheckout['step'][$step]['row']; ?>" data-id="<?php echo $step; ?>">
                        <div class="portlet-wrap">
                          ...
                          <div class="portlet-content">
                            ...
                            <input type="hidden" class="sort data-column" name="d_quickcheckout[step][<?php echo $step; ?>][column]" value="<?php echo $d_quickcheckout['step'][$step]['column']; ?>" />
                            <input type="hidden" class="sort data-row" name="d_quickcheckout[step][<?php echo $step; ?>][row]" value="<?php echo $d_quickcheckout['step'][$step]['row']; ?>" />
                          </div>
                        </div>
                      </li>
                    <?php } ?> 
            ...
            <div class="form-group">
              ...
              <?php if(isset($d_quickcheckout['design']['custom_style'])){ ?>
                <textarea name="d_quickcheckout[design][custom_style]" id="design_custom_style" class="form-control" rows="5"><?php echo $d_quickcheckout['design']['custom_style']; ?></textarea>
              <?php }else{ ?>
...
function addModule() { 
 ...
 html += ' <tr>';
 html += '  <td class="text-left"><select name="d_quickcheckout_module[' + module_row + '][layout_id]" class="form-control">';
 <?php foreach ($layouts as $layout) { ?>
 html += '   <option value="<?php echo $layout['layout_id']; ?>"><?php echo addslashes($layout['name']); ?></option>';
 <?php } ?>
 html += '  </select></td>';
 html += '  <td class="text-left"><select name="d_quickcheckout_module[' + module_row + '][position]" class="form-control">';
 html += '   <option value="content_top"><?php echo $text_content_top; ?></option>';
 html += '   <option value="content_bottom"><?php echo $text_content_bottom; ?></option>';
 html += '   <option value="column_left"><?php echo $text_column_left; ?></option>';
 html += '   <option value="column_right"><?php echo $text_column_right; ?></option>';
 html += '  </select></td>';
 html += '  <td class="text-left"><select name="d_quickcheckout_module[' + module_row + '][status]" class="form-control">';
  html += '   <option value="1" selected="selected"><?php echo $text_enabled; ?></option>';
  html += '   <option value="0"><?php echo $text_disabled; ?></option>';
  html += '  </select></td>';
 html += '  <td class="text-left"><input type="text" class="form-control" name="d_quickcheckout_module[' + module_row + '][sort_order]" value="" size="3" /></td>';
