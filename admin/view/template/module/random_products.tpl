...
<div id="content">
    <div class="page-header">
        <div class="container-fluid">
            <div class="pull-right">
                <button type="submit" form="form-latest" data-toggle="tooltip" title="<?php echo $button_save; ?>" class="btn btn-primary"><i
    ...
    <div class="container-fluid">
        <div class="well">
            Display random products from specific category.
        </div>
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-latest" class="form-horizontal">
                    ...
                    <div class="form-group">
                        <label class="col-sm-2 control-label" for="input-width"><?php echo $entry_category; ?></label>
                        <div class="col-sm-10">
                            <select name="category" class="form-control">
                                <?php foreach($shop_categories as $shop_category) { ?>
                                <option value="<?php echo $shop_category['category_id'] ?>"
                                <?php if($category == $shop_category['category_id']) echo 'selected'
                                ?>> <?php echo $shop_category['name'] ?></option>
                                <?php } ?>
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text" name="height" value="<?php echo $height; ?>" placeholder="<?php echo $entry_height; ?>"
