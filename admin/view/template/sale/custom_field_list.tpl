...
<div id="content">
  <div class="page-header">
    <div class="container-fluid">
      <div class="pull-right"><a href="<?php echo $add_custom; ?>" data-toggle="tooltip" title="<?php echo $button_add_custom; ?>" class="btn btn-primary"><i class="fa fa-plus"></i> <?php echo $button_add_custom; ?></a>
            ...
            <table class="table table-bordered table-hover">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td class="text-right"><a href="<?php echo $custom_field['edit_custom']; ?>" data-toggle="tooltip" title="<?php echo $button_edit_custom; ?>" class="btn btn-primary"><i class="fa fa-pencil"></i> <?php echo $button_edit_custom; ?></a>
<a href="<?php echo $custom_field['edit']; ?>" data-toggle="tooltip" title="<?php echo $button_edit; ?>" class="btn btn-primary"><i class="fa fa-pencil"></i></a></td>
                </tr>
                <?php } ?>
                <?php } else { ?>
                <tr>
