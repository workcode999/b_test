    ...
    <div class="panel panel-default">
      <div class="panel-heading">
        <h3 class="panel-title"><i class="fa fa-list"></i> 		
			<?php echo $order_id; ?> - <?php echo $shipping_firstname; ?> <?php echo $shipping_lastname; ?>
			<?php if ($order_status) { ?>
				 - <b><?php echo $order_status; ?></b>
			<?php } ?>
		</h3>
      </div>
      <div class="panel-body">
		<ul class="nav nav-tabs">
          ...
          <li class="active"><a href="#tab-shipping" data-toggle="tab"><?php echo $tab_shipping; ?></a></li>
          <?php } ?>
        ...
        <div class="tab-content">
		  ...
		  <div class="tab-pane" id="tab-payment">
			<table class="table table-bordered">
              <tr>
                <td>Name</td>
                <td><?php echo $payment_firstname; ?> <?php echo $payment_lastname; ?></td>
              </tr>
				...
				<tr>
					...
					<td class="text-left"><?php echo $product['model']; ?>
						...
						<small>- <?php echo $option['name']; ?>: <?php echo $option['value']; ?>
							<?php if($option['bust'] || $option['waist'] || $option['hip'] || $option['hollow'] || $option['height']) {?>
							
							(Bust: <?php echo $option['bust']; ?> in, Waist: <?php echo $option['waist']; ?> in, Hips: <?php echo $option['hip']; ?> in, Hollow to floor: <?php echo $option['hollow']; ?> in, Height: <?php echo $option['height']; ?> in)   
							<?php if($option['remarks'] && !empty($option['remarks'])){ ?><br/><span>&nbsp;- Remarks: <?php echo $option['remarks']; ?></span><?php } ?>				
							<?php } ?>
					   </small>
						<?php } else { ?>
						...
						<?php if ($comment) { ?>
						<br />
						&nbsp;<small> - <?php echo $text_comment; ?>: <?php echo $comment; ?></small>
						<?php } ?>
					</td>
