...
<div id="content">
  <div class="page-header">
    <div class="container-fluid">
      <div class="pull-right"><button type="submit" id="button-shipping" form="form-order" formaction="<?php echo $invoice; ?>&pdf=true" data-toggle="tooltip" title="<?php echo $button_pdf_invoice; ?>" class="btn btn-info"><i class="fa fa-file-pdf-o"></i></button>
	  <a href="<?php echo $export; ?>" data-toggle="tooltip" title="<?php echo $button_export; ?>" class="btn btn-success"><i class="glyphicon glyphicon-export"></i></a>
            ...
            <table class="table table-bordered table-hover">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td class="text-right"><a style="color:#666;text-decoration:underline;" href="<?php echo $order['view']; ?>"><?php echo $order['order_id']; ?></a></td>
                  ...
                  <td class="text-left"><a href="<?php echo $order['review_booster']; ?>" id="button-review-booster<?php echo $order['order_id']; ?>" data-value="<?php echo $order['order_id']; ?>" data-toggle="tooltip" title="Review Booster Notify" class="btn btn-warning"><i class="fa fa-send"></i></a>
...
$('input[name=\'filter_order_id\']').on('keydown', function(e) {
	if (e.keyCode == 13) {
