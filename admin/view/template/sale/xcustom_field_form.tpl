  ...
  <div class="container-fluid">
    ...
    <div class="panel panel-default">
      <div class="panel-heading">
        ...
        <button type="submit" form="form-custom-field" data-toggle="tooltip" title="<?php echo $button_save; ?>" class="btn btn-primary"><i class="fa fa-save"></i> <?php echo $button_save; ?></button>
      ...
      <div class="panel-body">
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-custom-field" class="form-horizontal">
          ...
          <div class="form-group required">
            <label class="col-sm-2 control-label" for="input-identifier"><span data-toggle="tooltip" title="<?php echo $entry_identifier_help; ?>"><?php echo $entry_identifier; ?></span></label>
            <div class="col-sm-10">
              <input type="text" name="identifier" value="<?php echo $identifier; ?>" placeholder="<?php echo $entry_identifier; ?>" id="input-identifier" class="form-control" />
              <?php if (isset($error_identifier)) { ?>
              <div class="text-danger"><?php echo $error_identifier; ?></div>
              <?php } ?>
            </div>
          </div>
          <div class="form-group">
            <label class="col-sm-2 control-label" for="input-mask"><span data-toggle="tooltip" title="<?php echo $entry_mask_help; ?>"><?php echo $entry_mask; ?></span></label>
            <div class="col-sm-10">
          ...
          <div class="form-group required">
            ...
            <div class="col-sm-10">
              <?php foreach ($languages as $language) { ?>
              <div class="input-group"><span class="input-group-addon"><img src="view/image/flags/<?php echo $language['image']; ?>" title="<?php echo $language['name']; ?>" /></span>
                <input type="text" name="custom_field_description[<?php echo $language['language_id']; ?>][error]" value="<?php echo isset($custom_field_description[$language['language_id']]) ? $custom_field_description[$language['language_id']]['error'] : ''; ?>" placeholder="<?php echo $entry_error; ?>" class="form-control" />
              </div>
              <?php if (isset($error_error[$language['language_id']])) { ?>
              <div class="text-danger"><?php echo $error_error[$language['language_id']]; ?></div>
              <?php } ?>
              <?php } ?>
            </div>
          </div>
          <div class="form-group">
            <label class="col-sm-2 control-label"><?php echo $entry_tips; ?></label>
            <div class="col-sm-10">
              <?php foreach ($languages as $language) { ?>
              <div class="input-group"><span class="input-group-addon"><img src="view/image/flags/<?php echo $language['image']; ?>" title="<?php echo $language['name']; ?>" /></span>
                <input type="text" name="custom_field_description[<?php echo $language['language_id']; ?>][tips]" value="<?php echo isset($custom_field_description[$language['language_id']]) ? $custom_field_description[$language['language_id']]['tips'] : ''; ?>" placeholder="<?php echo $entry_tips; ?>" class="form-control" />
              </div>
              <?php } ?>
            </div>
          </div>
          ...
          <thead>
          	<tr class="info">
              <td class="text-center first" colspan="8"><?php echo $entry_attributes; ?></td>
              <td class="text-center" colspan="4"><?php echo $entry_visibility; ?></td>
            </tr>
            <tr class="success">
              ...
              <td class="text-left value"><?php echo $entry_value; ?></td>
              <td class="text-left"><?php echo $entry_location; ?></td>
              <td class="text-left"><?php echo $entry_minimum; ?><span data-toggle="tooltip" title="<?php echo $char_help1; ?>"></span></td>
              <td class="text-left"><?php echo $entry_maximum; ?><span data-toggle="tooltip" title="<?php echo $char_help2; ?>"></span></td>
              <td class="text-left"><?php echo $entry_isnumeric; ?></td>
              <td class="text-left"><?php echo $entry_email; ?></td>
              <td class="text-left"><?php echo $entry_invoice; ?></td>
            </tr>
            </thead>
            <tbody>
            <tr>
              <td class="text-center"><input type="checkbox" name="status" value="1" <?php echo ($status?'checked="checked"':'');?>></td>              
              <td class="text-center"><input type="text" name="sort_order" value="<?php echo $sort_order; ?>" size="4" /></td>
              ...
              <td class="center value"><input type="text" name="value" value="<?php echo $value; ?>" placeholder="<?php echo $entry_value; ?>" id="input-value" class="form-control" /></td>              
              <td class="text-center"><select name="location" class="form-control">                
                <?php if ($location == 'account') { ?>
                <option value="account" selected><?php echo $text_account; ?></option>
                <?php } else { ?>
              ...
              <td class="text-center"><input type="text" name="minimum" value="<?php echo $minimum; ?>" size="4" /></td>
              <td class="text-center"><input type="text" name="maximum" value="<?php echo $maximum; ?>" size="4" /></td>
              <td class="text-center"><input type="checkbox" name="isnumeric" value="1" <?php echo ($isnumeric?'checked="checked"':'');?>></td>              
              <td class="text-center"><input type="checkbox" name="email_display" value="1" <?php echo ($email_display?'checked="checked"':'');?>></td>
              <td class="text-center"><input type="checkbox" name="invoice" value="1" <?php echo ($invoice?'checked="checked"':'');?>></td>
            </tr>
            </tbody>
            </table>
            </div>
        ...
        <thead>
            <tr class="danger">
              <td class="left"><?php echo $important_note; ?></td>
            </tr>
          </thead>
        
        <tr>
              <td class="left"><?php echo $address_message; ?> <a href="index.php?route=module/signup&token=<?php echo $token; ?>" target="_newtab">Link</a></td>
            </tr>
        <tr>
              <td class="left"><?php echo $fields_retreival1."<br/>".$fields_retreival2."<br/>".$fields_retreival3;?></td>
            </tr> 
        </table>
        </form>
      </div>
...
$('select[name=\'type\']').on('change', function() {
	if (this.value == 'select' || this.value == 'radio' || this.value == 'checkbox') {
		...
		$('.second').attr('colspan','11');
	} else {
		$('#custom-field-value').hide();
		$('#display-value').show();
		$('.value').show();
		$('.first').attr('colspan','8');
		$('.second').attr('colspan','12');
	}
