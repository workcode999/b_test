...
<style>thead:before, thead:after { display: none; }
...
<div class="container">
  <?php $loop=1;
	...
	<?php }?>
	<?php $loop++;?>
	<table class="table "><tr><td style="width: 50%;" class="text-right"><h1><?php echo $text_invoice; ?> #<?php echo $order['order_id']; ?></h1></td></tr></table>
      ...
      <tbody>
        <tr>
          <td style="width: 50%;">
            ...
            <?php } ?>
			<b><?php echo $text_email; ?></b>bjsbridal@hotmail.com<br />
