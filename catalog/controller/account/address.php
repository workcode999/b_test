...
class ControllerAccountAddress extends Controller {
	...
	public function index() {
		if($this->xtensions->isActive())$this->response->redirect($this->url->link('account/myaddress', '', 'SSL'));
	...
	protected function validateForm() {
		...
		foreach ($custom_fields as $custom_field) {
			if (($custom_field['location'] == 'address') && $custom_field['required'] && empty($this->request->post['custom_field'][$custom_field['custom_field_id']])) {
				$this->error['custom_field'][$custom_field['custom_field_id']] = sprintf($this->language->get('error_custom_field'), ucfirst(strtolower($custom_field['name'])));
			}
		}
