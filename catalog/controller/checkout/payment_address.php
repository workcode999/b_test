		...
		if (!$json) {
			if (isset($this->request->post['payment_address']) && $this->request->post['payment_address'] == 'existing') {
				...
				foreach ($custom_fields as $custom_field) {
					if (($custom_field['location'] == 'address') && $custom_field['required'] && empty($this->request->post['custom_field'][$custom_field['custom_field_id']] && (utf8_strlen(trim($this->request->post['custom_field'][$custom_field['custom_field_id']])) < 7 || utf8_strlen(trim($this->request->post['custom_field'][$custom_field['custom_field_id']])) > 32)) {
