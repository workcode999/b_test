        ...
        <tbody>
          <tr>
            ...
            <td class="text-left"><?php if ($payment_method) { ?>
			  ...
			  <?php } ?><br />
			 <?php if($order_status_name){ ?>
		     <b> <?php echo $text_order_status; ?></b>&nbsp;<?php echo $order_status_name; ?>
              <?php } ?></td>
          </tr>
        </tbody>
      </table>
          ...
          <tbody>
            ...
            <tr>
			  ...
			  <?php if(!empty($product['option'])) { ?>
                ...
                <br />
				&nbsp;
                &nbsp;<small><?php echo $option['name']; ?>: <?php echo $option['value']; ?><?php if(!empty($product['size_attr']) && $option['name'] == 'Size') { echo $product['size_attr']; } ?></small>
				<?php } ?>
                <?php } ?></td>
