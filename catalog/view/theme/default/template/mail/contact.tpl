...
<thead>
	<tr>
    	<th bgcolor="#ededed" style="font-size:14px;  font-weight:bold;"><?php echo $text_enquiry_customer; ?></th>
   	</tr>
</thead>
<tbody>
	<tr>
    	<td bgcolor="#f6f6f6" style="-ms-text-size-adjust:100%; mso-line-height-rule:exactly; font-family:Helvetica, Arial, sans-serif; font-size:12px; line-height:18px; border-bottom:1px solid #e0e0e0;" align="<?php echo $config['text_align']; ?>">
    		<?php echo $enquiry; ?>
        </td>
	</tr>
</tbody>
