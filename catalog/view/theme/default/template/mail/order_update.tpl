...
<p class="standard" align="<?php echo $config['text_align']; ?>" style="-ms-text-size-adjust:100%; mso-line-height-rule:exactly; font-family:Helvetica, Arial, sans-serif; font-size:12px; line-height:18px; color:<?php echo $config['body_font_color']; ?>; margin-top:0px; margin-bottom:8px;">
	<?php echo $text_update_order . ' ' . $order_id; ?><br />
	<?php echo $text_update_date_added . ' ' . $date_added; ?>
</p>

<?php if(isset($order_status) && isset($text_update_order_status)){ ?>
<p class="standard" align="<?php echo $config['text_align']; ?>" style="-ms-text-size-adjust:100%; mso-line-height-rule:exactly; font-family:Helvetica, Arial, sans-serif; font-size:12px; line-height:18px; color:<?php echo $config['body_font_color']; ?>; margin-top:0px; margin-bottom:8px;">
	<?php echo $text_update_order_status; ?><strong> <?php echo $order_status; ?></strong>
</p>
<?php } ?>

<?php if (isset($customer_id) && isset($order_url) && isset($text_update_link)) { ?>
<p class="link" align="<?php echo $config['text_align']; ?>" style="-ms-text-size-adjust:100%; mso-line-height-rule:exactly; font-family:Helvetica, Arial, sans-serif; font-size:12px; line-height:18px; color:<?php echo $config['body_font_color']; ?>; margin-top:5px; margin-bottom:15px;">
	...
	<a href="<?php echo $order_url; ?>" style="color:<?php echo $config['body_link_color']; ?>; text-decoration:none;" target="_blank">
		<b><?php echo $order_url; ?></b>
	</a>
</p>
<?php } ?>

<?php if(!empty($comment) && isset($text_update_comment)){ ?>
<p class="standard" align="<?php echo $config['text_align']; ?>" style="-ms-text-size-adjust:100%; mso-line-height-rule:exactly; font-family:Helvetica, Arial, sans-serif; font-size:12px; line-height:18px; color:<?php echo $config['body_font_color']; ?>; margin-top:0px; margin-bottom:0px;">
	<?php echo $text_update_comment; ?>
</p>
<div style="-ms-text-size-adjust:100%; mso-line-height-rule:exactly; font-family:Helvetica, Arial, sans-serif; font-size:12px; line-height:18px; color:<?php echo $config['body_font_color']; ?>; margin-bottom:15px;"><?php echo $comment; ?></div>
<?php } ?>

<p class="standard" align="<?php echo $config['text_align']; ?>" style="-ms-text-size-adjust:100%; mso-line-height-rule:exactly; font-family:Helvetica, Arial, sans-serif; font-size:12px; line-height:18px; color:<?php echo $config['body_font_color']; ?>; margin-top:0px; margin-bottom:0px;">
	<?php if(isset($text_update_footer)){ ?><?php echo $text_update_footer; ?><br style="line-height:18px;" /><?php } ?>
