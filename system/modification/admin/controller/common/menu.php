...
class ControllerCommonMenu extends Controller {
	public function index() {
		...
		$data['text_clear_caches']       = $this->language->get('text_clear_caches');
		$data['text_clear_allbutimage']  = $this->language->get('text_clear_allbutimage');
		$data['text_clear_all']          = $this->language->get('text_clear_all');
		$data['text_clear_vqmod']        = $this->language->get('text_clear_vqmod');
		$data['text_clear_image']        = $this->language->get('text_clear_image');
		$data['text_clear_system']       = $this->language->get('text_clear_system');
		$data['text_clear_minify']       = $this->language->get('text_clear_minify');
		$data['text_clear_seo']          = $this->language->get('text_clear_seo');
		$data['text_clear_page']         = $this->language->get('text_clear_page');

		$data['url_clear_allbutimage']   = $this->url->link('tool/clearcache/butimage', 'token=' . $this->session->data['token'], 'SSL');
		$data['url_clear_all']           = $this->url->link('tool/clearcache', 'token=' . $this->session->data['token'], 'SSL');
		$data['url_clear_vqmod']         = $this->url->link('tool/clearcache/vqmod', 'token=' . $this->session->data['token'], 'SSL');
		$data['url_clear_image']         = $this->url->link('tool/clearcache/image', 'token=' . $this->session->data['token'], 'SSL');
		$data['url_clear_system']        = $this->url->link('tool/clearcache/system', 'token=' . $this->session->data['token'], 'SSL');
		$data['url_clear_minify']        = $this->url->link('tool/clearcache/minify', 'token=' . $this->session->data['token'], 'SSL');
		$data['url_clear_seo']           = $this->url->link('tool/clearcache/seo', 'token=' . $this->session->data['token'], 'SSL');
		$data['url_clear_page']          = $this->url->link('tool/clearcache/page', 'token=' . $this->session->data['token'], 'SSL');
		...
		$data['xcustom_fields'] = $this->url->link('sale/xcustom_field', 'token=' . $this->session->data['token'], 'SSL');
		$data['text_xcustom_field'] = $this->language->get('text_xcustom_field');
