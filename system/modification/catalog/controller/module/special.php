	...
	public function index($setting) {
		...
		if ($results) {
			...
			if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/module/special.tpl')) {
			    ...
			    $contents = $this->load->view($this->config->get('config_template') . '/template/module/special.tpl', $data);
			    global $aFolder;
                            global $modulesPath;
			    ...
			    $contents = $this->load->view('default/template/module/special.tpl', $data);
			    global $aFolder;
                            global $modulesPath;
