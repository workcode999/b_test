...
class ControllerProductManufacturer extends Controller {
	public function index() {
		...
		if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/product/manufacturer_list.tpl')) {
			$this->response->setOutput(magicRender($this->load->view($this->config->get('config_template') . '/template/product/manufacturer_list.tpl', $data),$this,'manufacturers',(isset($results) ? $results : array())));
		} else {
			$this->response->setOutput(magicRender($this->load->view('default/template/product/manufacturer_list.tpl', $data),$this,'manufacturers',(isset($results) ? $results : array())));
		}
	}
	...
	public function info() {
		...
		if ($manufacturer_info) {
			...
			if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/product/manufacturer_info.tpl')) {
				$this->response->setOutput(magicRender($this->load->view($this->config->get('config_template') . '/template/product/manufacturer_info.tpl', $data),$this,'manufacturers',(isset($results) ? $results : array())));
			} else {
				$this->response->setOutput(magicRender($this->load->view('default/template/product/manufacturer_info.tpl', $data),$this,'manufacturers',(isset($results) ? $results : array())));
			}
		} else {
			$url = '';
