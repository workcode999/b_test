...
$product_info['images'] = $results;
			...
			if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/product/product.tpl')) {
				$this->response->setOutput(magicRender($this->load->view($this->config->get('config_template') . '/template/product/product.tpl', $data),$this,'product',$product_info));
			} else {
				$this->response->setOutput(magicRender($this->load->view('default/template/product/product.tpl', $data),$this,'product',$product_info));
			}
		} else {
			$url = '';
